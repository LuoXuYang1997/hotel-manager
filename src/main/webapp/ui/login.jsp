...
<div class="loginbody">
    ...
    <form id="form1" name="form1" method="post" action="../login.s">
        ...
        <div class="loginbox">
            <ul>
                <li><input type="text" class="loginuser" name="account"/></li>
                <li><input type="password" class="loginpwd" name="password"/></li>
                <li><input type="submit" class="loginbtn" value="登录" name="button"/>
